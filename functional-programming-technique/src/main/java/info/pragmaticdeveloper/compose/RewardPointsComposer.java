...
public class RewardPointsComposer {
    private Predicate<RewardPoints> lessThan100 = rewardPoint -> rewardPoint.getValue() < 100;
    private Predicate<RewardPoints> moreThan40 = rewardPoint -> rewardPoint.getValue() > 40;
    private Predicate<RewardPoints> lessThan40 = rewardPoint -> rewardPoint.getValue() < 40;
    private Predicate<RewardPoints> moreThan100 = rewardPoint -> rewardPoint.getValue() > 100;
