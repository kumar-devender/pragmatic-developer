...
public class SupervisorSupport implements SupportServiceable {
    private final SupportServiceable nextHandler;
    private final ServiceLevel SERVICE_SUPPORT_TYPE = ServiceLevel.LEVEL_TWO;

    public SupervisorSupport(SupportServiceable handler) {
