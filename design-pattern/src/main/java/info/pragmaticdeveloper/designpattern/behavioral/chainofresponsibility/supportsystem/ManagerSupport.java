...
public class ManagerSupport implements SupportServiceable {
    private final SupportServiceable nextHandler;
    private final ServiceLevel SERVICE_SUPPORT_TYPE = ServiceLevel.LEVEL_THREE;

    public ManagerSupport(SupportServiceable handler) {
